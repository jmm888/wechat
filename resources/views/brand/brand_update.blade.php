...
@endif
<form action="{{url('brand/brand_upd_do/'.$data->brand_id)}}" method="post" enctype="multipart/form-data">
	@csrf
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="/laravel/img/coin02.png" /><span><a href="{{route ('main')}}">首页</a>&nbsp;-&nbsp;<a
					href="#">商品品牌管理</a>&nbsp;-</span>&nbsp;品牌修改
			</div>
		</div>
		<div class="page ">
			<!-- 上传广告页面样式 -->
			<div class="banneradd bor">
				...
				<div class="baBody">
					<div class="bbD">
                        ...
                        <img src="http://www.jmm_laupload.com/{{$data->brand_logo}}" width="80" height="80">
					</div>
					<div class="bbD">
					...
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;排序：<input
							class="input3" type="text" name="brand_order" value="{{$data->brand_order}}"/>
					</div>
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;品牌描述：
						<div class="btext2">
					...
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;是否显示：<label><input
							type="radio" checked="checked" name="is_show" value="1" @if($data->is_show==1)checked @endif/>&nbsp;是</label><label><input
							type="radio" name="is_show" value="0" @if($data->is_show==0) checked @endif/>&nbsp;否</label>
					</div>
					<div class="bbD">
						<p class="bbDP">
							<input type="button" value="确认修改" class="btn_ok btn_yes">
