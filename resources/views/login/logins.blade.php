...
@section('content')
    ...
    <form action="" method="post">
        <div style="margin-top: 50px" >
            ...
            <input type="button" class="btn btn-info" value="登录"></input>
        </div>
    </form>
    ...
    <script>
        $(".btn").click(function(){
            ...
            var url = "http://www.jmm_wxlaravel.com/api/login_do";
            $.ajax({
                url:url,
                ...
                success:function(res)
                {
                    ...
                    {
                        alert(res.msg);
                        location.href="http://www.jmm_wxlaravel.com/api/new_show";
                    }else{
                        alert('用户名或密码错误');
                    }
                }
